...
import static qa.engineeric.invoice.web.rest.TestUtil.sameNumber;
...
import qa.engineeric.invoice.domain.enumeration.InvoiceStatus;
import qa.engineeric.invoice.domain.enumeration.PaymentMethod;
...
class InvoiceResourceIT {
    ...
    void createInvoice() throws Exception {
        ...
        assertThat(testInvoice.getUserStoreOwnerId()).isEqualTo(DEFAULT_USER_STORE_OWNER_ID);
        assertThat(testInvoice.getUserId()).isEqualTo(DEFAULT_USER_ID);
    ...
    void checkUserStoreOwnerIdIsRequired() throws Exception {
        ...
        // set the field null
        invoice.setUserStoreOwnerId(null);
    ...
    void putNewInvoice() throws Exception {
        ...
        Invoice testInvoice = invoiceList.get(invoiceList.size() - 1);
        assertThat(testInvoice.getUserStoreOwnerId()).isEqualTo(UPDATED_USER_STORE_OWNER_ID);
        assertThat(testInvoice.getUserId()).isEqualTo(UPDATED_USER_ID);
